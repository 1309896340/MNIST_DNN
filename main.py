...
if __name__ == '__main__':
    ...
    # 参数集中管理
    param = {"lr": 0.00002, "epoch": 300, "batchsize": 400, "train_rate": 0.8, "dropratio": 0.85}
    ...
    # 像素值归一化
    train_images = center_normalize(train_images)
    valid_images = center_normalize(valid_images)
